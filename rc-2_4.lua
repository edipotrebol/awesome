...
beautiful.init("/home/edipotrebol/.config/awesome/themes/rotate/theme.lua")
...
tags = {
    ...
    layout = { layouts[1], layouts_simple[2], layouts_simple[1], layouts_simple[1], layouts[1], layouts[1] }
}
for s = 1, screen.count() do
